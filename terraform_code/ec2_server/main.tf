...
resource "aws_instance" "my-ec2" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "sudo gpg --dearmor -o /usr/share/keyrings/jenkins-keyring.gpg /tmp/jenkins.key",
      ...
      # use this for any error
      #"wget https://pkg.jenkins.io/debian-stable/binary/jenkins_2.555.2_all.deb",
      #"sudo dpkg -i jenkins_2.555.2_all.deb || true",
